...
import './edit-comment.css'; // Import your CSS file for any additional styles
  ...
  return (
    ...
    >
        ...
        > 
             ...
             <h3  id="edit-comment-title-id">Edite Comment</h3>
                 <button onClick={onClose} disabled={isSaving} className="CloseIcon">
