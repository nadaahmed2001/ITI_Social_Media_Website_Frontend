...
const API_BASE_URL= "http://itihub-backend-ikxqcw-ed0c9f-161-156-161-124.traefik.me/api/";
...
const api2 = axios.create({
  baseURL: "http://itihub-backend-ikxqcw-ed0c9f-161-156-161-124.traefik.me/api/",
  headers: {
    "Content-Type": "application/json",
  },
  withCredentials: true,
...
export const verifyOtp = (data) => {
  return axios.post('http://itihub-backend-ikxqcw-ed0c9f-161-156-161-124.traefik.me/api/users/verify-otp/', data, {
    headers: {
      'Content-Type': 'application/json',
    },
