    ...
    return (
        <div className="flex h-full">
            <div className="flex flex-col h-full">
                ...
                <div className={`w-72 text-[#7a2226] h-full p-4 fixed md:relative transform mt-3 rounded-lg 
            ${isSidebarOpen ? "translate-x-0 z-40" : "-translate-x-full z-30"} 
                    ...
                    bg-white/90 backdrop-blur-lg overflow-y-auto shadow-xl flex-grow`}>
                            ...
                            <div key={chat.id} className="flex justify-between items-center p-2 
                                ...
                                <Typography className=" !text-[#7a2226] !font-medium">
                                    ...
                                    <Typography variant="caption" className=" !text-[#585858]">
                                        {chat.last_message && chat.last_message.content ? `${chat.last_message.sender_username === chat.username ? "You: " : `${chat.last_message.sender_username}: `}: ${chat.last_message.content}` : "No messages yet"}
                                    </Typography>
                                </div>
                                <Typography variant="caption" className=" !text-[#585858] ">
                            ...
                            <div key={chat.id} className="flex justify-between items-center p-2 
                                ...
                                <div>
                                    ...
                                    <Typography  className=" !text-[#585858]" variant="caption">
                                        {chat.last_message && `${chat.last_message.sender} : ${chat.last_message.content}` ? chat.last_message.content : "No messages yet"}
                                    </Typography>
                                </div>
                                <Typography  className=" !text-[#585858]" variant="caption" >
